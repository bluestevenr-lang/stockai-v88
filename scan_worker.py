...
def _fallback_us():
    """美股备用池 ~350 只（S&P500 核心 + 纳斯达克成长 + 中概）"""
    return list({x[2]: x for x in [
        # ── 大型科技 ──
        ...
        ("KLAC","科磊","KLAC"),("TXN","德州仪器","TXN"),("ADI","亚德诺","ADI"),
        ("NXPI","恩智浦","NXPI"),("ON","安森美","ON"),("MCHP","微芯科技","MCHP"),
        ("STX","希捷","STX"),("WDC","西数","WDC"),("SWKS","Skyworks","SWKS"),
        ("MRVL","迈威科技","MRVL"),("MPWR","芯源系统","MPWR"),("CDNS","Cadence","CDNS"),
        ("SNPS","Synopsys","SNPS"),("ANSS","ANSYS","ANSS"),("ASML","ASML","ASML"),
        ("TSM","台积电","TSM"),("ARM","ARM控股","ARM"),("SMCI","超微电脑","SMCI"),
        # ── 软件/云/AI ──
        ...
        ("VEEV","Veeva","VEEV"),("PATH","UiPath","PATH"),("APP","AppLovin","APP"),
        ("TTD","Trade Desk","TTD"),("RBLX","Roblox","RBLX"),("AI","C3.ai","AI"),
        ("BILL","Bill.com","BILL"),("TOST","Toast","TOST"),("GTLB","GitLab","GTLB"),
        ("DOCN","DigitalOcean","DOCN"),("S","SentinelOne","S"),("CFLT","Confluent","CFLT"),
        ("SAMSF","Samsung","SAMSF"),("SAP","SAP","SAP"),("CSCO","思科","CSCO"),
        ("IBM","IBM","IBM"),("ACN","埃森哲","ACN"),("IT","Gartner","IT"),
        # ── 消费/零售/媒体 ──
        ("NFLX","奈飞","NFLX"),("DIS","迪士尼","DIS"),("COST","Costco","COST"),
        ("WMT","沃尔玛","WMT"),("TGT","塔吉特","TGT"),("NKE","耐克","NKE"),
        ("SBUX","星巴克","SBUX"),("MCD","麦当劳","MCD"),("CMCSA","康卡斯特","CMCSA"),
        ("CHTR","特许通信","CHTR"),("PARA","派拉蒙","PARA"),("GM","通用汽车","GM"),
        ("F","福特","F"),("RIVN","Rivian","RIVN"),("UBER","优步","UBER"),
        ("ABNB","Airbnb","ABNB"),("BKNG","Booking","BKNG"),("EXPE","Expedia","EXPE"),
        ("DASH","DoorDash","DASH"),("SHOP","Shopify","SHOP"),("ETSY","Etsy","ETSY"),
        ("EBAY","eBay","EBAY"),("ZM","Zoom","ZM"),("WBD","华纳兄弟","WBD"),
        ("LYV","Live Nation","LYV"),("LULU","Lululemon","LULU"),("ROST","Ross","ROST"),
        ("TJX","TJX","TJX"),("HD","家得宝","HD"),("LOW","劳氏","LOW"),
        ("KO","可口可乐","KO"),("PEP","百事可乐","PEP"),("PG","宝洁","PG"),
        ("CL","高露洁","CL"),("CLX","氯乐斯","CLX"),("MNST","怪物饮料","MNST"),
        ("STZ","星座品牌","STZ"),("KHC","卡夫亨氏","KHC"),("GIS","通用磨坊","GIS"),
        ("CPB","金宝汤","CPB"),("SJM","斯玛克","SJM"),("K","家乐氏","K"),
        ("CMG","Chipotle","CMG"),("YUM","百胜","YUM"),("DPZ","达美乐","DPZ"),
        ("QSR","RBI","QSR"),("DRI","Darden","DRI"),("EAT","Brinker","EAT"),
        ("MAR","万豪","MAR"),("HLT","希尔顿","HLT"),("H","凯悦","H"),
        ("MGM","美高梅","MGM"),("LVS","金沙","LVS"),("WYNN","永利","WYNN"),
        # ── 金融 ──
        ...
        ("TRV","旅行者","TRV"),("CB","Chubb","CB"),("ALL","好事达","ALL"),
        ("PRU","保诚","PRU"),("MET","大都会","MET"),("PGR","Progressive","PGR"),
        ("AIG","AIG","AIG"),("HIG","哈特福德","HIG"),("AFL","Aflac","AFL"),
        ("FIS","FIS","FIS"),("FI","Fiserv","FI"),("GPN","Global Payments","GPN"),
        ("DFS","Discover","DFS"),("ALLY","Ally Financial","ALLY"),
        # ── 医疗健康 ──
        ...
        ("BSX","波士顿科学","BSX"),("EW","爱德华兹","EW"),("MDT","美敦力","MDT"),
        ("SYK","史赛克","SYK"),("ABT","雅培","ABT"),("BAX","百特","BAX"),
        ("BDX","碧迪医疗","BDX"),("HCA","HCA医疗","HCA"),("CI","Cigna","CI"),
        ("HUM","Humana","HUM"),("ELV","Elevance","ELV"),("CVS","CVS健康","CVS"),
        ("IQV","IQVIA","IQV"),("A","安捷伦","A"),("WAT","Waters","WAT"),
        ("IDXX","IDEXX","IDXX"),("HOLX","Hologic","HOLX"),("TECH","Bio-Techne","TECH"),
        # ── 工业/国防/能源 ──
        ...
        ("DUK","杜克能源","DUK"),("SO","南方公司","SO"),("AEP","美国电力","AEP"),
        ("EXC","埃克斯隆","EXC"),("D","Dominion","D"),("ED","ConEd","ED"),
        ("FDX","联邦快递","FDX"),("UPS","联合包裹","UPS"),("GPC","Genuine Parts","GPC"),
        ("FAST","Fastenal","FAST"),("NSC","诺福克南方","NSC"),("UNP","联合太平洋","UNP"),
        ("CSX","CSX","CSX"),("DAL","达美","DAL"),("UAL","联合航空","UAL"),
        ("AAL","美国航空","AAL"),("LUV","西南航空","LUV"),
        # ── 房地产/材料 ──
        ("PLD","普洛斯","PLD"),("AMT","美国铁塔","AMT"),("CCI","皇冠城堡","CCI"),
        ("EQIX","Equinix","EQIX"),("DLR","数字房地产","DLR"),("O","Realty Income","O"),
        ("VTR","Ventas","VTR"),("WELL","Welltower","WELL"),("ARE","Alexandria","ARE"),
        ("LIN","林德","LIN"),("APD","空气化工","APD"),("FCX","自由港","FCX"),
        ("NEM","纽蒙特","NEM"),("AA","铝业","AA"),("CF","CF工业","CF"),
        ("MOS","马赛克","MOS"),("NUE","纽柯钢铁","NUE"),("STLD","Steel Dynamics","STLD"),
        # ── 中概股 ──
        ...
        ("LAIX","鲨鱼移动","LAIX"),("TUYA","涂鸦智能","TUYA"),("KC","金山云","KC"),
        ("CANG","仓储物流","CANG"),("GDS","万国数据","GDS"),("NTES","网易","NTES"),
        # ── ETF/指数 ──
        ("SPY","标普500ETF","SPY"),("QQQ","纳斯达克ETF","QQQ"),
        ("IWM","罗素2000ETF","IWM"),("XLK","科技ETF","XLK"),
        ("SOXX","半导体ETF","SOXX"),("ARKK","ARK创新ETF","ARKK"),
        ("GLD","黄金ETF","GLD"),("TLT","长债ETF","TLT"),("XBI","生物科技ETF","XBI"),
        ("XLE","能源ETF","XLE"),("XLF","金融ETF","XLF"),("XLV","医疗ETF","XLV"),
        ("VNQ","房地产ETF","VNQ"),("HYG","高收益债ETF","HYG"),
    ]}.values())


def _fallback_hk():
    """港股备用池 ~200 只（恒指/国企/科技/消费/金融全覆盖）"""
    return list({x[2]: x for x in [
        # ── 科技/互联网 ──
        ...
        ("9626","哔哩哔哩","9626.HK"),("9888","百度集团","9888.HK"),
        ("9901","新东方","9901.HK"),("0772","阅文集团","0772.HK"),
        ("0981","中芯国际","0981.HK"),("2018","瑞声科技","2018.HK"),
        ("6690","海尔智家","6690.HK"),("1478","丘钛科技","1478.HK"),
        ("3396","联想控股","3396.HK"),("3033","南方恒生科技","3033.HK"),
        # ── 金融/保险/证券 ──
        ...
        ("1336","新华保险","1336.HK"),("0066","港铁公司","0066.HK"),
        ("2888","渣打集团","2888.HK"),("0083","信和置业","0083.HK"),
        ("3328","交通银行","3328.HK"),("6818","光大银行","6818.HK"),
        ("1339","人民保险","1339.HK"),("2601","中国太保","2601.HK"),
        ("6886","华泰证券","6886.HK"),("1988","民生银行","1988.HK"),
        ("1658","邮储银行","1658.HK"),("6196","浙商银行","6196.HK"),
        ("0998","中信银行","0998.HK"),("2356","大新银行","2356.HK"),
        ("3618","重庆农商行","3618.HK"),
        # ── 电信/基础设施 ──
        ("0941","中国移动","0941.HK"),("0728","中国电信","0728.HK"),
        ("0762","中国联通","0762.HK"),("0002","中电控股","0002.HK"),
        ("0003","香港煤气","0003.HK"),("0006","电能实业","0006.HK"),
        ("1038","长江基建","1038.HK"),("1997","九龙仓置业","1997.HK"),
        ("0384","中国燃气","0384.HK"),("0836","华润电力","0836.HK"),
        ("0902","华能国际","0902.HK"),("3366","中兴通讯","3366.HK"),
        # ── 汽车/新能源 ──
        ("1211","比亚迪","1211.HK"),("0175","吉利汽车","0175.HK"),
        ("2238","广汽集团","2238.HK"),("0489","东风集团","0489.HK"),
        ("2333","长城汽车","2333.HK"),("1958","北汽蓝谷","1958.HK"),
        ("0753","中国国航","0753.HK"),("0670","中国东方航空","0670.HK"),
        ("1055","中国南方航空","1055.HK"),("0293","国泰航空","0293.HK"),
        # ── 消费/零售/品牌 ──
        ("0291","华润啤酒","0291.HK"),("9633","农夫山泉","9633.HK"),
        ("0168","青岛啤酒","0168.HK"),("2319","蒙牛乳业","2319.HK"),
        ("6862","海底捞","6862.HK"),("0322","康师傅控股","0322.HK"),
        ("1929","周大福","1929.HK"),("0551","裕元集团","0551.HK"),
        ...
        ("2020","安踏体育","2020.HK"),("6808","高鑫零售","6808.HK"),
        ("0656","复星国际","0656.HK"),("0303","VTech Holdings","0303.HK"),
        ("1876","百威亚太","1876.HK"),("3799","达利食品","3799.HK"),
        ("1579","颐海国际","1579.HK"),("0960","龙湖集团","0960.HK"),
        ("0709","佐丹奴","0709.HK"),("0330","思捷环球","0330.HK"),
        # ── 医疗/生物科技 ──
        ...
        ("1099","国药控股","1099.HK"),("3692","翰森制药","3692.HK"),
        ("0874","白云山","0874.HK"),("6821","凯莱英","6821.HK"),
        ("9995","荣昌生物","9995.HK"),("1530","三生制药","1530.HK"),
        ("2689","九洲药业","2689.HK"),("6185","康希诺","6185.HK"),
        ("9889","药明合联","9889.HK"),("2276","上海谊众","2276.HK"),
        # ── 地产/工业/建筑 ──
        ("0016","新鸿基地产","0016.HK"),("0823","领展基金","0823.HK"),
        ("0883","中海油","0883.HK"),("2899","紫金矿业","2899.HK"),
        ("0101","恒隆地产","0101.HK"),("0017","新世界发展","0017.HK"),
        ("1109","华润置地","1109.HK"),("0012","恒基地产","0012.HK"),
        ("0688","中国海外发展","0688.HK"),("2007","碧桂园","2007.HK"),
        ("0914","海螺水泥","0914.HK"),("0004","九龙仓集团","0004.HK"),
        ("0001","长和","0001.HK"),("0019","太古股份A","0019.HK"),
        ("1113","长实集团","1113.HK"),("0012","恒基地产","0012.HK"),
        ("3311","中国建筑","3311.HK"),("1800","中国交建","1800.HK"),
        ("1668","中国建筑国际","1668.HK"),("0688","中国海外","0688.HK"),
        ("6098","碧桂园服务","6098.HK"),("1766","中国中车","1766.HK"),
        # ── 能源/原材料/资源 ──
        ("0386","中国石化","0386.HK"),("1088","中国神华","1088.HK"),
        ("0857","中国石油","0857.HK"),("0358","江西铜业","0358.HK"),
        ("1171","兖矿能源","1171.HK"),("3993","洛阳钼业","3993.HK"),
        ("0347","鞍钢股份","0347.HK"),("1898","中煤能源","1898.HK"),
        ("1772","赣锋锂业","1772.HK"),("1919","中远海控","1919.HK"),
        ("1199","中远港口","1199.HK"),("0144","招商港口","0144.HK"),
        ("0270","粤海投资","0270.HK"),("0548","深高速","0548.HK"),
        ("1052","越秀交通","1052.HK"),("0363","上海实业","0363.HK"),
        # ── ETF/指数 ──
        ("2800","盈富基金","2800.HK"),("2828","恒生国企","2828.HK"),
        ("3032","恒生科技ETF","3032.HK"),("3188","华夏恒生ETF","3188.HK"),
    ]}.values())


def _fallback_cn():
    """A股备用池 ~250 只（沪深300 + 中证500 + 科创板 + 创业板核心）"""
    return list({x[2]: x for x in [
        # ── 白酒/食品饮料 ──
        ...
        ("601888","中国中免","601888.SS"),("603288","海天味业","603288.SS"),
        ("600887","伊利股份","600887.SS"),("002714","牧原股份","002714.SZ"),
        ("000661","长春高新","000661.SZ"),("300498","温氏股份","300498.SZ"),
        ("600597","光明乳业","600597.SS"),("002570","贝因美","002570.SZ"),
        ("000895","双汇发展","000895.SZ"),("600233","圆通速递","600233.SS"),
        ("002352","顺丰控股","002352.SZ"),("600233","圆通速递","600233.SS"),
        ("002311","海大集团","002311.SZ"),("000food","东鹏饮料","605499.SS"),
        ("605499","东鹏饮料","605499.SS"),("600298","安琪酵母","600298.SS"),
        # ── 家电/消费制造 ──
        ("002415","海康威视","002415.SZ"),("000333","美的集团","000333.SZ"),
        ("000651","格力电器","000651.SZ"),("002050","三花智控","002050.SZ"),
        ("000100","TCL科技","000100.SZ"),("600690","海尔智家","600690.SS"),
        ("002236","大华股份","002236.SZ"),("002241","歌尔股份","002241.SZ"),
        ("001696","宗申动力","001696.SZ"),("600839","四川长虹","600839.SS"),
        ("000069","华侨城A","000069.SZ"),("002727","一心堂","002727.SZ"),
        # ── 金融/银行/证券 ──
        ...
        ("601995","中金公司","601995.SS"),("601669","中国电建","601669.SS"),
        ("000002","万科A","000002.SZ"),("600048","保利发展","600048.SS"),
        ("001979","招商蛇口","001979.SZ"),("600346","恒力石化","600346.SS"),
        ("601601","中国太保","601601.SS"),("601398","工商银行","601398.SS"),
        ("601939","建设银行","601939.SS"),("600015","华夏银行","600015.SS"),
        ("601169","北京银行","601169.SS"),("600928","西安银行","600928.SS"),
        ("601229","上海银行","601229.SS"),("002142","宁波银行","002142.SZ"),
        ("600919","江苏银行","600919.SS"),("600908","无锡银行","600908.SS"),
        # ── 新能源/光伏/储能 ──
        ...
        ("600732","爱旭股份","600732.SS"),("603806","福斯特","603806.SS"),
        ("688223","晶科能源","688223.SS"),("688599","天奇股份","688599.SS"),
        ("002460","赣锋锂业","002460.SZ"),("002009","天齐锂业","002009.SZ"),
        ("300896","爱美客","300896.SZ"),("688561","奇安信","688561.SS"),
        ("002311","海大集团","002311.SZ"),("688389","普源精电","688389.SS"),
        ("300415","伊之密","300415.SZ"),("300666","江丰电子","300666.SZ"),
        ("605116","奥特维","605116.SS"),("603659","璞泰来","603659.SS"),
        # ── 医药/医疗 ──
        ...
        ("600763","通策医疗","600763.SS"),("002038","双鹭药业","002038.SZ"),
        ("603369","今世缘","603369.SS"),("600867","通化东宝","600867.SS"),
        ("000513","丽珠集团","000513.SZ"),("002773","迈克生物","002773.SZ"),
        ("300529","健帆生物","300529.SZ"),("688089","腾景科技","688089.SS"),
        ("300146","汤臣倍健","300146.SZ"),("002252","上海莱士","002252.SZ"),
        ("600535","天士力","600535.SS"),("603806","福斯特","603806.SS"),
        ("688006","杭可科技","688006.SS"),("300661","圣邦股份","300661.SZ"),
        # ── 科技/半导体/AI ──
        ("688981","中芯国际","688981.SS"),("000063","中兴通讯","000063.SZ"),
        ("002230","科大讯飞","002230.SZ"),("300059","东方财富","300059.SZ"),
        ("603501","韦尔股份","603501.SS"),("688012","中微公司","688012.SS"),
        ("688036","传音控股","688036.SS"),("000725","京东方A","000725.SZ"),
        ("688041","海光信息","688041.SS"),("688099","晶晨股份","688099.SS"),
        ("688256","寒武纪","688256.SS"),("688111","金山办公","688111.SS"),
        ("688012","中微公司","688012.SS"),("688396","华润微","688396.SS"),
        ("002049","紫光股份","002049.SZ"),("603160","汇顶科技","603160.SS"),
        ("688819","天合光能","688819.SS"),("688561","奇安信","688561.SS"),
        ("300274","阳光电源","300274.SZ"),("688223","晶科能源","688223.SS"),
        ("300782","卓胜微","300782.SZ"),("002049","紫光股份","002049.SZ"),
        ("688027","国盾量子","688027.SS"),("688122","西部超导","688122.SS"),
        ("688429","时代电气","688429.SS"),("688418","震安科技","688418.SS"),
        ("002179","中航光电","002179.SZ"),("300957","贝泰妮","300957.SZ"),
        ("688088","虹软科技","688088.SS"),("688055","龙腾光电","688055.SS"),
        # ── 工业/原材料/能源 ──
        ...
        ("603993","洛阳钼业","603993.SS"),("600160","巨化股份","600160.SS"),
        ("601919","中远海控","601919.SS"),("600585","海螺水泥","600585.SS"),
        ("000100","TCL科技","000100.SZ"),("600050","中国联通","600050.SS"),
        ("601728","中国电信","601728.SS"),("601881","中国银河","601881.SS"),
        ("600010","包钢股份","600010.SS"),("601186","中国铁建","601186.SS"),
        ("600031","三一重工","600031.SS"),("000538","云南白药","000538.SZ"),
        ("601006","大秦铁路","601006.SS"),("601390","中国中铁","601390.SS"),
        ("601628","中国人寿","601628.SS"),("600000","浦发银行","600000.SS"),
        ("000100","TCL科技","000100.SZ"),("601998","中信银行","601998.SS"),
        # ── ETF ──
        ("510300","沪深300ETF","510300.SS"),("510500","中证500ETF","510500.SS"),
        ("159915","创业板ETF","159915.SZ"),("588000","科创50ETF","588000.SS"),
        ("510050","上证50ETF","510050.SS"),("159919","沪深300ETF","159919.SZ"),
    ]}.values())
