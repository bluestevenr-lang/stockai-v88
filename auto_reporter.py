...
请基于以上真实数据，生成一份**机构级精华日报**。要求：
- 语言精炼有深度，像高盛晨报，不说废话
- 严格控制在 3200 字以内（钉钉单条限制）
- 使用以下结构，标题不变：

## 🌐 市场体制判断
一句话定性（Risk On / Off / Neutral），点明核心驱动力和关键风险，不超过60字。

## 🎯 今日精选推荐
美股3只、港股3只、A股3只，从扫描高分中选逻辑最清晰的。
格式：**代码 名称** 现价xxx｜方向：多/观望｜逻辑：一句核心理由（20字内）

## 🌊 蓄势精选（各市场1只）
还未启动但信号积累中，适合提前布局。
格式：**代码 名称**｜关注区间：xxx-xxx｜触发条件：20字内

## 📋 自选股全览
对每一只自选股逐一点评，不得遗漏，格式：
**名称(代码)** 现价xxx｜判断（持有/加仓/减仓/观望）+ 核心理由（15字内）

注意：直接输出报告内容，不要任何前缀说明或解释。"""
