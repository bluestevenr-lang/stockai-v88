...
| 维度 | 规则 |
|------|------|
| **入场** | EMA20 > EMA50（均线多头） AND 45 < RSI(14) < 68（动量健康） AND MACD 金叉 |
| **止损** | 入场价 −5% 硬止损 |
| **止盈** | 入场价 +12% 目标 |
| **追踪止损** | 持仓期间最高点回撤 8% 自动平仓（锁定利润） |
| **风控** | 最多同时持仓 5 只 · 单仓占总资金 18% |

**关注标的**：英伟达 NVDA、苹果 AAPL、特斯拉 TSLA、亚马逊 AMZN、Meta  
港股：腾讯 0700.HK、阿里 9988.HK、汇丰 0005.HK  
A股：贵州茅台 600519、宁德时代 300750、中国平安 601318
