"""Compatibility bridge that routes legacy Gemini-shaped V88 calls to GPT-6.
...
this module guarantees that every executable call uses the user's Codex
subscription and the configured ``gpt-6-astra`` model.
"""
...
from desktop_gpt_subscription import api_key, complete, model_name
...
class GenerativeModel:
    ...
    def generate_content(self, contents: Any, **kwargs: Any) -> _Response:
        ...
        text, _body = complete(
            ("你是V88 GPT-6与经典巨著研究助手。只据所给事实推演；缺少的新闻、价格、目标或财务数字标未知。"
             "应用斯波朗迪保住资本/有序趋势与欧奈尔止错；中长线结合林奇的基本面核验与西格尔的长期风险视角。"
             "给出反方情景和可检验的失效条件。概率是情景估计而非实测胜率，不得用自己的文字代签中央交易审核。"
